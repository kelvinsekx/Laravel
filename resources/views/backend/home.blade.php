...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8 mb-4">
            <div class="card">
                <div class="card-header">Dashboard <ion-icon ios="logo-octocat" md="logo-octocat"></ion-icon></div>
...
<div class="list-group-item">
  ...
  <div class="list-group-item">
    <div class="row-action-primary">
      ...
      <a href="/admin/posts/create" class="btn btn-primary btn-raised">Create A Post</a> </div> </div>
      <div class="list-group-separator"></div>
    </div>
