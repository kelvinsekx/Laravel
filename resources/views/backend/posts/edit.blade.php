@extends('master')
  ...
  @section('content')
  <div class="container col-md-8 col-md-offset-2 mt-3 moos">
    <div class="well well bs-component">
      <form class="form-horizontal" method="post">
        ...
        <fieldset>
          <legend class="header">Edit a post</legend>
        ...
        <div class="form-group">
          ...
          <div class="col-lg-10"> <select class="form-control" id="categories" name="categories[]" multiple>
